...
const SideBar = () => {
    ...
    return (
      ...
      <div
        ...
        className={`bg-blue-800  w-80 space-y-6 py-7 px-4 absolute z-10  inset-y-0 left-0 transform md:fixed top-0 md:translate-x-0 transition duration-200 ease-in-out ${mobilesidebar}`}
      >
        {/* logo */}
        <Link href="/">
